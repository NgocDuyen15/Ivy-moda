...
<div class="amin-contenr-right-product-list">
                <h1>DANH SACH</h1>
                <table>
                    <tr>
                        <th id="1">STT</th>
                    ...
                    <tr>
                        ...
                        <td><a href="productdelete.php?product_id=<?php echo $result['product_id'] ?>">XÓA</a>|
                        <a href="productupdate.php?product_id=<?php echo $result['product_id'] ?>">SỬA</a></td>
                    </tr>
                    <?php
                            }
                        }
